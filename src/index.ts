...
async function run() {
  ...
  // Healthcheck para o Easypanel/Docker — não toca na Evolution API,
  // só confirma que o processo está de pé e aceitando conexões.
  ...
  app.post("/messages", async (req, res) => {
    ...
    // O express.json() acima ja consumiu o stream do request, entao o
    // handlePostMessage nao consegue mais le-lo ("stream is not readable").
    // Passamos o body ja parseado no terceiro argumento.
